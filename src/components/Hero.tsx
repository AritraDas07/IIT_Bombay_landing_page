    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 text-center relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className={`text-5xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <span className="inline-block ml-4 animate-bounce-slow animation-delay-800">2</span>
          ...
          <p className={`text-2xl md:text-3xl text-slate-300 mb-4 font-light transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            IIT Bombay
          </p>
          
          <p className={`text-lg md:text-xl text-slate-400 mb-12 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            Asia's Largest Science & Technology Festival
          </p>

          {/* Enhanced statistics with hover effects */}
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="group p-8 bg-slate-800/30 rounded-2xl backdrop-blur-sm border border-slate-700 hover:border-blue-500 transition-all duration-500 hover:scale-110 hover:rotate-1">
              <div className="relative">
                <Users className="w-16 h-16 text-blue-400 mx-auto mb-6 group-hover:scale-125 transition-transform duration-300" />
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 group-hover:text-blue-400 transition-colors">200,000+</h3>
              <p className="text-slate-400 group-hover:text-slate-300 transition-colors">Participants Worldwide</p>
            </div>
            ...
            <div className="group p-8 bg-slate-800/30 rounded-2xl backdrop-blur-sm border border-slate-700 hover:border-purple-500 transition-all duration-500 hover:scale-110 hover:-rotate-1">
              <div className="relative">
                <Calendar className="w-16 h-16 text-purple-400 mx-auto mb-6 group-hover:scale-125 transition-transform duration-300" />
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">100+</h3>
              <p className="text-slate-400 group-hover:text-slate-300 transition-colors">Exciting Events</p>
            </div>
            ...
            <div className="group p-8 bg-slate-800/30 rounded-2xl backdrop-blur-sm border border-slate-700 hover:border-pink-500 transition-all duration-500 hover:scale-110 hover:rotate-1">
              <div className="relative">
                <Trophy className="w-16 h-16 text-pink-400 mx-auto mb-6 group-hover:scale-125 transition-transform duration-300" />
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 group-hover:text-pink-400 transition-colors">₹2Cr+</h3>
              <p className="text-slate-400 group-hover:text-slate-300 transition-colors">Prize Money</p>
            </div>
          </div>
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <button className="group relative bg-gradient-to-r from-blue-500 to-purple-500 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:from-blue-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-blue-500/25 overflow-hidden">
            ...
            <button 
              ...
              className="group relative border-2 border-slate-500 text-slate-300 px-10 py-5 rounded-2xl font-bold text-lg hover:border-blue-500 hover:text-blue-400 transition-all duration-300 hover:bg-slate-800/50 backdrop-blur-sm overflow-hidden"
            >
          ...
          <div className={`mt-16 p-6 bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-2xl border border-slate-600 backdrop-blur-sm transition-all duration-1000 delay-1200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        ...
        <p className="text-slate-500 text-sm mt-2 text-center">Scroll to explore</p>
      </div>
    </section>
  );
};
